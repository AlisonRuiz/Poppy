...
(cl:in-package poppy_torso_control-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name poppy_torso_control-msg:<Trajectory> is deprecated: use poppy_torso_control-msg:Trajectory instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader poppy_torso_control-msg:joint-val is deprecated.  Use poppy_torso_control-msg:joint instead.")
  (joint m))

(cl:ensure-generic-function 'trajectory-val :lambda-list '(m))
(cl:defmethod trajectory-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader poppy_torso_control-msg:trajectory-val is deprecated.  Use poppy_torso_control-msg:trajectory instead.")
  (trajectory m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Trajectory>)))
  ...
  (cl:format cl:nil "# This message stores a movement~%#~%# * joint: name of the joint~%#~%# * trajectory: array of positions~%#~%~%string      joint~%float32[]   trajectory~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Trajectory)))
  "Returns full string definition for message of type 'Trajectory"
  (cl:format cl:nil "# This message stores a movement~%#~%# * joint: name of the joint~%#~%# * trajectory: array of positions~%#~%~%string      joint~%float32[]   trajectory~%~%"))
